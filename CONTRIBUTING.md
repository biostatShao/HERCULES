...
1. Do not change priors, grids, convergence, annotation initialization, the
   directional pairwise M3 model, the validation/test boundary, or Stage-3
   learner libraries without explicit scientific authorization.
