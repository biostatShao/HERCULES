...
from hercules.core.model.BayesPRSModel import BayesPRSModel
...
class HyperparameterSearch(object):
    ...
    `HerculesModel` model. This interface is old and will likely be deprecated
    in future releases. It is recommended to use the `HerculesGrid` class
    ...
    def __init__(self,
        ...
        :param model: A `PRSModel`-derived object (e.g. HerculesModel).
