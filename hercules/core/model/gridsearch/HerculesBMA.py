...
class HerculesBMA(HerculesGrid):
    """
    The `HerculesBMA` class is an extension of the `HerculesGrid` class that
    implements Bayesian model averaging for the `HerculesModel` models in the grid.
    ...
    def __init__(self,
        ...
        Initialize the `HerculesBMA` model.

        :param gdl: An instance of `GWADataLoader`
        :param grid: An instance of `HyperparameterGrid`
        :param kwargs: Additional keyword arguments for the HerculesModel model
        """
