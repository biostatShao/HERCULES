...
from .HerculesModel import HerculesModel
...
class HerculesMix(HerculesModel):
    """
    A class for the Variational Inference for Polygenic Risk Scores (HerculesModel) model
    parametrized with the sparse mixture prior on the effect sizes. The class inherits
    many of the methods and attributes from the `HerculesModel` class unchanged. However,
    ...
    effectively reduces `HerculesMix` to the `HerculesModel` model.
    ...
    def __init__(self,
        ...
        :param kwargs: Additional keyword arguments to pass to the HerculesModel model.
        """
