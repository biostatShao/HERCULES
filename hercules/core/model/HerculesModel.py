...
class HerculesModel(BayesPRSModel):
    ...
    def __init__(self,
        ...
        Initialize the HerculesModel model.
        ...
        procedure. Useful for debugging/model checking. Currently, we allow the user to track the following:
            ...
            * User may also provide arbitrary functions that takes the `HerculesModel` object as input and
    ...
    def objective(self):
        ...
        for the HerculesModel method is the Evidence Lower-Bound (ELBO) in this case.

        !!! seealso "See Also"
            * [elbo][hercules.core.model.HerculesModel.HerculesModel.elbo]
