...
class BayesPRSModel:
    ...
    specific Bayesian PRS models, such as `LDPred` and `HerculesModel`.
    ...
    def m(self) -> int:
        ...
        !!! seealso "See Also"
            * [n_snps][hercules.core.model.BayesPRSModel.BayesPRSModel.n_snps]
    ...
    def n_snps(self) -> int:
        """
        !!! seealso "See Also"
            * [m][hercules.core.model.BayesPRSModel.BayesPRSModel.m]
